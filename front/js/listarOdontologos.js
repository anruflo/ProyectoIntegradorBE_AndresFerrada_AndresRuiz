      ...
      .then(data => {
         ...
         data.forEach(odontologo => {
            ...
            row.innerHTML = `
              ...
              <td>
                <button class="btn btn-primary btn-sm" onclick="editOdontologo(${odontologo.id},'${odontologo.matricula}','${odontologo.nombre}','${odontologo.apellido}')">Modificar</button>
...
editOdontologo = function (id, matricula, nombre, apellido) {
